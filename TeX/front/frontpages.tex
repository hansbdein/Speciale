...
\begin{titlingpage}
  ...
  \begin{adjustwidth*}{\frontpagecorrection-2cm}{-\frontpagecorrection-2cm}
    ...
    {\fontsize{22pt}{26pt}\selectfont\spread{\textsc{APODORA}: \par A Novel Code for Describing}} \par
    {\fontsize{22pt}{26pt}\selectfont\spread{Big Bang Nucleosynthesis}} \par
      %\textsc{Apodora}
    \vspace{0.5cm}

    {\fontsize{14pt}{18pt}\selectfont\spread{APODORA: \par En ny kode til at beskrive Big Bang Kernesyntese}} \par%l{\o}se
